...
import {
    ChevronDown, MessageSquare, Mic, Volume2, Save, Play, RefreshCcw, Lock, X, Download, ArrowLeft, Trash2, Layout, Users
} from 'lucide-react';
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 pb-20">
                ...
                <div className="sticky top-0 z-10 -mx-8 -mt-8 mb-8 flex items-center justify-between border-b border-gray-800 bg-gray-950/90 px-8 py-4 backdrop-blur-md">
                    ...
                    <div className="flex gap-2">
                        <button
                            type="button"
                            onClick={() => router.push(`/agent/${agent.id}/workflow`)}
                            className="flex items-center gap-2 rounded border border-blue-500/20 bg-blue-500/10 px-4 py-2 text-sm font-bold text-blue-400 hover:bg-blue-500/20 transition-all shadow-[0_0_15px_rgba(59,130,246,0.1)]"
                        >
                            <Layout size={16} />
                        ...
                        <button
                            type="button"
                            onClick={() => router.push(`/agent/${agent.id}/contacts`)}
                            className="flex items-center gap-2 rounded border border-purple-500/20 bg-purple-500/10 px-4 py-2 text-sm font-bold text-purple-400 hover:bg-purple-500/20 transition-all shadow-[0_0_15px_rgba(168,85,247,0.1)]"
                        >
                            <Users size={16} />
                            Contacts
                        </button>
                ...
                <div className="grid gap-8 lg:grid-cols-3">
                    ...
                    <div className="space-y-8 lg:col-span-2">
                        ...
                        <div className="rounded-lg bg-indigo-600/10 border border-indigo-500/20 p-6 flex items-center justify-between">
                            <div>
                                <h3 className="text-white font-bold mb-1">Visual Workflow Studio</h3>
                                <p className="text-xs text-gray-400">Design your agent's conversation flow using our drag-and-drop designer.</p>
                            </div>
                            <button
                                type="button"
                                onClick={() => router.push(`/agent/${agent.id}/workflow`)}
                                className="bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2 rounded text-xs font-bold transition-all"
                            >
                                Launch Designer
                            </button>
                        </div>
